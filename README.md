...
**Version 1.7 now supports both Leaflet v2 ([Leaflet 2.0.0-alpha.1](https://leafletjs.com/2025/05/18/leaflet-2.0.0-alpha.html)) and v1.9.4, in a global/vanilla script environment only. See usage below.**
